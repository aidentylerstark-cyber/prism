 ...
 *
 * Adapted for Prism from the Firestorm Viewer sources. Name filtering is
 * applied while rebuilding the list here in the panel because the base
 * viewer's LLScrollListCtrl has no row filtering support.
 * $/LicenseInfo$
 */
...
private:
    ...
    boost::signals2::connection mRadarColumnConfigConnection;
