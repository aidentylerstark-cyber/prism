 ...
 *
 * Adapted for Prism from the Firestorm Viewer sources. The LSL bridge
 * z-offset machinery and the toast reporting option were removed for the
 * initial port (see fsradar.cpp for details).
 * $/LicenseInfo$
 */
