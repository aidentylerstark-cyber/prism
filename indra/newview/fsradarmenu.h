 ...
 *
 * Adapted for Prism from the Firestorm Viewer sources. Contact set,
 * netmap mark color, avatar alignment, script info, derender and
 * estate/land moderation entries were removed (their subsystems or
 * LLAvatarActions extensions do not exist in the base viewer).
 * $/LicenseInfo$
 */
